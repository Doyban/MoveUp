  ...
  private boolean doSendIntent(
    ...
    cordova.getThreadPool().execute(new SocialSharingRunnable(callbackContext) {
      public void run() {
        ...
        // PendingIntent.getBroadcast(cordova.getActivity().getApplicationContext(), 0,
        // receiverIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        PendingIntent pendingIntent = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
          pendingIntent = PendingIntent.getBroadcast(cordova.getActivity().getApplicationContext(), 0, receiverIntent,
